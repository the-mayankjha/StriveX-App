  ...
  return (
    <AnimatePresence>
      {type && (
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-[#000000]/85 backdrop-blur-xl">
          <motion.div
            initial={{ scale: 0.9, opacity: 0, y: 40 }}
            animate={{ scale: 1, opacity: 1, y: 0 }}
            exit={{ scale: 0.9, opacity: 0, y: 40 }}
            className={cn(
              "w-full max-w-sm bg-surface/98 border-2 relative overflow-hidden transition-all duration-500",
              isSoloLevelingMode 
                ? "border-primary/50 shadow-glow-blue rounded-none" 
                : "border-primary/20 shadow-xl rounded-[2rem]",
            )}
          ...
          >
            {/* Border Lighting Trace - Solo Mode Only */}
            {isSoloLevelingMode && (
            ...
            {/* Scanline Effect - Solo Mode Only */}
            {isSoloLevelingMode && (
            ...
            <div className="relative z-10 p-8 space-y-8">
              ...
              <div className="space-y-6 text-center pt-4">
                <h2 className={cn(
                  "text-3xl font-black uppercase tracking-tight text-primary transition-all duration-300",
              ...
              <button
                onClick={onClose}
                className={cn(
                  "w-full py-5 font-black uppercase tracking-[0.4em] transition-all active:scale-[0.98] border-2 relative group overflow-hidden",
                  isSoloLevelingMode 
